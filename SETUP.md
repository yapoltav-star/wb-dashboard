...
4. Финансы: PIN по умолчанию `1234` (файл `frontend/index.html`, константа `FINANCE_PIN`) — смени под себя и задеплой снова. Данные кредитов/себестоимости живут в твоём Supabase, в коде их нет.
