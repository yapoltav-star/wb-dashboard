...
Данные: `/v5/product/info/prices` + `/v1/actions` (+ товары в акциях).  
Если есть **Premium Pro** — дополнительно `/v1/product/prices/details` (`customer_price`, `discount_percent` = скидка за счёт Ozon).
